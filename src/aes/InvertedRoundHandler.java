 ...
 *
 *	'InvertedRoundHandler.java'
 *  File Description:
 *		description here
 */
package aes;

public class InvertedRoundHandler {
	SBoxCalculator sb;
	int rcon;
	int[][] mixMatrix = {
		{2,3,1,1},
	...
	public int binMultiply(int a, int b) {
		...
		if (b == 1) {return a;} //doesn't change
		int result = 0;
		...
		if (b == 3) {result = result ^ a;} // multiplying by 3 is the same as multiplying by 2 and then XORing with the original value
